...
wget -q --no-check-certificate https://raw.githubusercontent.com/tikhonlavrev/VPN-For-Russia/main/core/ssr-core.sh -O /etc/init.d/ssrmu
...
Start_SSR(){
	check_pid
	wget -q -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/tikhonlavrev/VPN-For-Russia/main/core/ssr-core.sh"
