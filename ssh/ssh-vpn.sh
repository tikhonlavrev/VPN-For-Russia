...
curl -sS https://raw.githubusercontent.com/tikhonlavrev/VPN-For-Russia/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/tikhonlavrev/VPN-For-Russia/main/ssh/newudpgw"
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/tikhonlavrev/VPN-For-Russia/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://raw.githubusercontent.com/tikhonlavrev/VPN-For-Russia/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/tikhonlavrev/VPN-For-Russia/main/banner/issue.net"
